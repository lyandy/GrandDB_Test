...
- (const char *)andy_stringForColumnIndex:(int)columnIdx {
...
- (const char *)andy_stringForColumn:(NSString*)columnName {
    return [self andy_stringForColumnIndex:[self columnIndexForName:columnName]];
}
